(function () {
  ...
  var translations = {
    zh: {
      'meta.title': 'OpenClaw Command Center',
      'logo.subtitle': 'OpenClaw 控制台',
      'pilot.model': '模型',
      'pilot.theme': '主题',
      'pilot.drawer': '抽屉',
      ...
      'results.eyebrow': '助手结果流',
      'results.title': 'Markdown 直出，不要气泡',
      'results.final': '最终输出',
      'results.trace': '逻辑链',
      'results.waiting': '等待助手',
      'results.placeholder': '连接网关后，助手的输出会以纯 Markdown 区块直接呈现在这里。',
      'results.traceEmpty': '还没有逻辑链事件。',
      'results.stream': '助手实时流',
      'results.live': '实时',
      'results.events': '{count} 条事件',
      'connect.title': '连接网关',
      'connect.copy': '如果没有自动接入，请粘贴网关 Token。',
      'connect.save': '保存',
      'connect.connect': '连接',
      ...
      'easy.qqbotSttEnabledHelp': '收到 QQ 语音后，先转成文字再交给助手。',
      ...
      'tab.ai.desc': '这页不展示原始字段，而是告诉你当前默认如何调用助手、会用什么模型、当前谁在工作。',
    ...
    en: {
      'meta.title': 'OpenClaw Command Center',
      'logo.subtitle': 'OpenClaw Command Center',
      'pilot.model': 'Model',
      'pilot.theme': 'Theme',
      'pilot.drawer': 'Drawer',
      ...
      'results.eyebrow': 'Assistant Result Stream',
      'results.title': 'Markdown output, no bubbles',
      'results.final': 'Final output',
      'results.trace': 'Logic chain',
      'results.waiting': 'Waiting for assistant',
      'results.placeholder': 'Connect the gateway and assistant output will render here as plain markdown blocks.',
      'results.traceEmpty': 'No logic-chain events yet.',
      'results.stream': 'Assistant Stream',
      'results.live': 'live',
      'results.events': '{count} events',
      'connect.title': 'Connect Gateway',
      'connect.copy': 'Paste the gateway token if auto-connect did not attach.',
      'connect.save': 'Save',
      ...
      'easy.qqbotSttEnabledHelp': 'Convert QQ voice messages into text before the assistant handles them.',
      ...
      'tab.ai.desc': 'This page explains how the default assistant is configured, which models it can use, and what is active now.',
